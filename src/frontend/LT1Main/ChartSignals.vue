...
export default defineComponent({
    ...
    methods: {
        ...
        _pushRecord(result: SimulationResult) {
            ...
            datasets[2].data.push({ x: t.valueOf(), y: result.y.Vmx??NaN })
            datasets[3].data.push({ x: t.valueOf(), y: result.y.kir??NaN })
            datasets[4].data.push({ x: t.valueOf(), y: result.y.Uid??NaN })
